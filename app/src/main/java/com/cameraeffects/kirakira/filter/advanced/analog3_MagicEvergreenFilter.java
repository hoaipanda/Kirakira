...
public class analog3_MagicEvergreenFilter extends analog3_GPUImageFilter {
    private int[] mToneCurveTexture = {-1};
    private int mToneCurveTextureUniformLocation;

    public analog3_MagicEvergreenFilter(){
        super(NO_FILTER_VERTEX_SHADER, analog3_OpenGlUtils.readShaderFromRawResource(R.raw.evergreen));
    }
