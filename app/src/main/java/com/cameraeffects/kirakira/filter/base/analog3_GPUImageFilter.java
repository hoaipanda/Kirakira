...
public class analog3_GPUImageFilter {
    ...
    public analog3_GPUImageFilter() {
        this(NO_FILTER_VERTEX_SHADER, NO_FILTER_FRAGMENT_SHADER);
    }

    public analog3_GPUImageFilter(final String vertexShader, final String fragmentShader) {
    ...
    public void onInit() {
        mGLProgId = analog3_OpenGlUtils.loadProgram(mVertexShader, mFragmentShader);
    ...
    public void onDraw(final int textureId, final FloatBuffer cubeBuffer,
        ...
        if (textureId != analog3_OpenGlUtils.NO_TEXTURE) {
