...
public class analog3_MagicSkinWhitenFilter extends analog3_GPUImageFilter {
    ...
    public analog3_MagicSkinWhitenFilter() {
        super(NO_FILTER_VERTEX_SHADER, analog3_OpenGlUtils.readShaderFromRawResource(R.raw.skinwhiten));
    }
