...
public class analog3_MagicLookupFilter extends analog3_GPUImageFilter {
    ...
    public analog3_MagicLookupFilter(String table) {
        super(NO_FILTER_VERTEX_SHADER, LOOKUP_FRAGMENT_SHADER);
        this.table = table;
    }

    public int mLookupTextureUniform;
    public int mLookupSourceTexture = analog3_OpenGlUtils.NO_TEXTURE;
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                mLookupSourceTexture = analog3_OpenGlUtils.loadTexture(analog3_FilterContext.context, table);
            }
        });
    }
