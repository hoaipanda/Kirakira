...
public class analog3_MagicWaldenFilter extends analog3_GPUImageFilter {
    private int[] inputTextureHandles = {-1, -1};
    private int[] inputTextureUniformLocations = {-1, -1};
    private int mGLStrengthLocation;
    private Context context;

    public analog3_MagicWaldenFilter( ) {
        super(NO_FILTER_VERTEX_SHADER, analog3_OpenGlUtils.readShaderFromRawResource(R.raw.walden));
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                inputTextureHandles[0] = analog3_OpenGlUtils.loadTexture(context, "filter/walden_map.png");
                inputTextureHandles[1] = analog3_OpenGlUtils.loadTexture(context, "filter/vignette_map.png");
            }
        });
    }
}
