...
public class analog3_MagicBrooklynFilterF extends analog3_GPUImageFilter {
    private int[] inputTextureHandles = {-1,-1,-1};
    private int[] inputTextureUniformLocations = {-1,-1,-1};
    private int mGLStrengthLocation;
    private Context context;

    public analog3_MagicBrooklynFilterF( ){
        super(NO_FILTER_VERTEX_SHADER, analog3_OpenGlUtils.readShaderFromRawResource(R.raw.brooklyn));
    ...
    public void onInitialized(){
        ...
        runOnDraw(new Runnable(){
            public void run(){
                inputTextureHandles[0] = analog3_OpenGlUtils.loadTexture(context, "filter/brooklynCurves1.png");
                inputTextureHandles[1] = analog3_OpenGlUtils.loadTexture(context, "filter/filter_map_first.png");
                inputTextureHandles[2] = analog3_OpenGlUtils.loadTexture(context, "filter/brooklynCurves2.png");
            }
        });
    }
}
