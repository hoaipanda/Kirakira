...
public class analog3_GPUImageWhiteBalanceFilter extends analog3_GPUImageFilter {
    ...
    public analog3_GPUImageWhiteBalanceFilter() {
        this(5000.0f, 0.0f);
    }

    public analog3_GPUImageWhiteBalanceFilter(final float temperature, final float tint) {
