...
public class analog3_MagicSunriseFilter extends analog3_GPUImageFilter {
    ...
    public analog3_MagicSunriseFilter( ) {
        super(NO_FILTER_VERTEX_SHADER, analog3_OpenGlUtils.readShaderFromRawResource(R.raw.sunrise));
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                ...
                GLES20.glActiveTexture(GLES20.GL_TEXTURE4);
                mMaskGrey1TextureId = analog3_OpenGlUtils.loadTexture(context, "filter/amaro_mask1.jpg");
                GLES20.glActiveTexture(GLES20.GL_TEXTURE5);
                mMaskGrey2TextureId = analog3_OpenGlUtils.loadTexture(context, "filter/amaro_mask2.jpg");
                GLES20.glActiveTexture(GLES20.GL_TEXTURE6);
                mMaskGrey3TextureId = analog3_OpenGlUtils.loadTexture(context, "filter/toy_mask1.jpg");
            }
        });
    }
}
