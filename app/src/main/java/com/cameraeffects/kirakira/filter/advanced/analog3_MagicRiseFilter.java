...
public class analog3_MagicRiseFilter extends analog3_GPUImageFilter {
    private int[] inputTextureHandles = {-1, -1, -1};
    private int[] inputTextureUniformLocations = {-1, -1, -1};
    private Context context;

    public analog3_MagicRiseFilter( ) {
        super(NO_FILTER_VERTEX_SHADER, analog3_OpenGlUtils.readShaderFromRawResource(R.raw.rise));
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                inputTextureHandles[0] = analog3_OpenGlUtils.loadTexture(context, "filter/blackboard1024.png");
                inputTextureHandles[1] = analog3_OpenGlUtils.loadTexture(context, "filter/overlaymap.png");
                inputTextureHandles[2] = analog3_OpenGlUtils.loadTexture(context, "filter/risemap.png");
            }
        });
    }
}
