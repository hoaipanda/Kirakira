...
public class analog3_MagicWarmFilter extends analog3_GPUImageFilter {
    ...
    public analog3_MagicWarmFilter( ) {
        super(NO_FILTER_VERTEX_SHADER, analog3_OpenGlUtils.readShaderFromRawResource(R.raw.warm));
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                ...
                mMaskGrey1TextureId = analog3_OpenGlUtils.loadTexture(context, "filter/warm_layer1.jpg");
                mMaskGrey2TextureId = analog3_OpenGlUtils.loadTexture(context, "filter/bluevintage_mask1.jpg");
            }
        });
    }
}
