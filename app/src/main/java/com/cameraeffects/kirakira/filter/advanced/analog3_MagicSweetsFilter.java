...
public class analog3_MagicSweetsFilter extends analog3_GPUImageFilter {
    ...
    public analog3_MagicSweetsFilter( ){
        super(NO_FILTER_VERTEX_SHADER, analog3_OpenGlUtils.readShaderFromRawResource(R.raw.sweets));
    ...
    public void onInitialized(){
        ...
        runOnDraw(new Runnable(){
            public void run(){
                ...
                mMaskGrey1TextureId = analog3_OpenGlUtils.loadTexture(context, "filter/rise_mask2.jpg");
            }
        });
    }
}
