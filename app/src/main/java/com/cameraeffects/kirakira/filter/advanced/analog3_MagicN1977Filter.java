...
public class analog3_MagicN1977Filter extends analog3_GPUImageFilter {
    private int[] inputTextureHandles = {-1, -1};
    private int[] inputTextureUniformLocations = {-1, -1};
    private int mGLStrengthLocation;
    private Context context;

    public analog3_MagicN1977Filter() {
        super(NO_FILTER_VERTEX_SHADER, analog3_OpenGlUtils.readShaderFromRawResource(R.raw.n1977));
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                inputTextureHandles[0] = analog3_OpenGlUtils.loadTexture(context, "filter/n1977map.png");
                inputTextureHandles[1] = analog3_OpenGlUtils.loadTexture(context, "filter/n1977blowout.png");
            }
        });
    }
}
