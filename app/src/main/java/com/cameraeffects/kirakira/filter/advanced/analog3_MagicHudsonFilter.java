...
public class analog3_MagicHudsonFilter extends analog3_GPUImageFilter {
    private int[] inputTextureHandles = {-1,-1,-1};
    private int[] inputTextureUniformLocations = {-1,-1,-1};
    private int mGLStrengthLocation;
    private Context context;

    public analog3_MagicHudsonFilter( ){
        super(NO_FILTER_VERTEX_SHADER, analog3_OpenGlUtils.readShaderFromRawResource(R.raw.hudson));
    ...
    public void onInitialized(){
        ...
        runOnDraw(new Runnable(){
            public void run(){
                inputTextureHandles[0] = analog3_OpenGlUtils.loadTexture(context, "filter/hudsonbackground.png");
                inputTextureHandles[1] = analog3_OpenGlUtils.loadTexture(context, "filter/overlaymap.png");
                inputTextureHandles[2] = analog3_OpenGlUtils.loadTexture(context, "filter/hudsonmap.png");
            }
        });
    }
}
