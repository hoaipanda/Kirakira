...
public class analog3_MagicNostalgiaFilter extends analog3_GPUImageFilter {
    ...
    public analog3_MagicNostalgiaFilter(){
        super(NO_FILTER_VERTEX_SHADER, analog3_OpenGlUtils.readShaderFromRawResource(R.raw.nostalgia));
    }
