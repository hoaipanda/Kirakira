...
public class analog3_MagicInkwellFilter extends analog3_GPUImageFilter {
    private int[] inputTextureHandles = {-1};
    private int[] inputTextureUniformLocations = {-1};
    private int mGLStrengthLocation;
    private Context context;

    public analog3_MagicInkwellFilter( ) {
        super(NO_FILTER_VERTEX_SHADER, analog3_OpenGlUtils.readShaderFromRawResource(R.raw.inkwell));
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                inputTextureHandles[0] = analog3_OpenGlUtils.loadTexture(context, "filter/inkwellmap.png");
            }
        });
    }
}
