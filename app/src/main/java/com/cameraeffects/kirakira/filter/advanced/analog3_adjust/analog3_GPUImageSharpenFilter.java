...
public class analog3_GPUImageSharpenFilter extends analog3_GPUImageFilter {
    ...
    public analog3_GPUImageSharpenFilter() {
        this(0.0f);
    }

    public analog3_GPUImageSharpenFilter(final float sharpness) {
