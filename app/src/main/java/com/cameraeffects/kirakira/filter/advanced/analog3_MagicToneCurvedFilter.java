...
public class analog3_MagicToneCurvedFilter extends analog3_GPUImageFilter {
    ...
    private int[] mToneCurveTexture = new int[]{analog3_OpenGlUtils.NO_TEXTURE};
    ...
    public analog3_MagicToneCurvedFilter() {
    ...
    protected void onDrawArraysPre() {
        if (mToneCurveTexture[0] != analog3_OpenGlUtils.NO_TEXTURE) {
            GLES20.glActiveTexture(GLES20.GL_TEXTURE3);
            GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mToneCurveTexture[0]);
