...
public class analog3_JSSunsetFilter extends analog3_GPUImageFilter {
    ...
    public analog3_JSSunsetFilter( ){
        super(NO_FILTER_VERTEX_SHADER, analog3_OpenGlUtils.readShaderFromRawResource(R.raw.sunset));
    ...
    public void onInitialized(){
        ...
        runOnDraw(new Runnable(){
            public void run(){
                ...
                mMaskGrey1TextureId = analog3_OpenGlUtils.loadTexture(context, "filter/rise_mask1.jpg");
                mMaskGrey2TextureId = analog3_OpenGlUtils.loadTexture(context, "filter/rise_mask2.jpg");
            }
        });
    }
}
