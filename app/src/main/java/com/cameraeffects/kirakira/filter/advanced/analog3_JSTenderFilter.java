...
public class analog3_JSTenderFilter extends analog3_GPUImageFilter {
    ...
    public analog3_JSTenderFilter( ){
        super(NO_FILTER_VERTEX_SHADER, analog3_OpenGlUtils.readShaderFromRawResource(R.raw.tender));
    ...
    public void onInitialized(){
        ...
        runOnDraw(new Runnable(){
            public void run(){
                ...
                mMaskGrey1TextureId = analog3_OpenGlUtils.loadTexture(context, "filter/bluevintage_mask1.jpg");
            }
        });
    }
}
