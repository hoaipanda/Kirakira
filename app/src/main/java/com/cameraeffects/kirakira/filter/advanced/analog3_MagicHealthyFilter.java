...
public class analog3_MagicHealthyFilter extends analog3_GPUImageFilter {
    ...
    public analog3_MagicHealthyFilter() {
        super(NO_FILTER_VERTEX_SHADER, analog3_OpenGlUtils.readShaderFromRawResource(R.raw.healthy));
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                ...
                mMaskGrey1TextureId = analog3_OpenGlUtils.loadTexture(context, "filter/healthy_mask_1.jpg");
            }
        });
    }
