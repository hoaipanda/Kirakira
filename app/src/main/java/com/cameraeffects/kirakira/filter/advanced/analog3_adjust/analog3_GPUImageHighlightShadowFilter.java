...
public class analog3_GPUImageHighlightShadowFilter extends analog3_GPUImageFilter {
    ...
    public analog3_GPUImageHighlightShadowFilter() {
        this(0.0f, 1.0f);
    }

    public analog3_GPUImageHighlightShadowFilter(final float shadows, final float highlights) {
