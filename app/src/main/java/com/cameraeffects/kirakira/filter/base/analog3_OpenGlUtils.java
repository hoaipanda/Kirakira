...
public class analog3_OpenGlUtils {
    ...
    public static int loadTexture(final Context context, final String name){
        ...
        if (textureHandle[0] != 0){
            ...
            final Bitmap bitmap = analogjapan1_getImageFromAssetsFile(context,name);
            ...
            // Recycle the bitmap, since its FilterItem has been loaded into OpenGL.
            bitmap.recycle();
        }
    ...
    private static Bitmap analogjapan1_getImageFromAssetsFile(Context context, String fileName){
        Bitmap image = null;
    ...
    public static String readShaderFromRawResource(final int resourceId){
        final InputStream inputStream = analog3_FilterContext.context.getResources().openRawResource(
                resourceId);
