...
public class CameraSource {
    ...
    public void setLightCamera(int light) {
        if (mCamera != null){
            ...
            parameters.setExposureCompensation(light);
    ...
    public CameraSource start(int cameraId) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }

            mCamera = createCamera(cameraId);
     ...
     */
    public CameraSource start(SurfaceHolder surfaceHolder, int cameraId) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
...
//            mCamera.setPreviewDisplay(surfaceHolder);
    ...
    private void setDefaultParameters(Camera mCamera) {
        Camera.Parameters parameters = mCamera.getParameters();
    ...
    public void setFlashMode(int modeSelect) {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                Camera.Parameters parameters = mCamera.getParameters();
    ...
    private Camera createCamera(int cameraId) {
        int requestedCameraId = cameraId;
